...
- Name: Clubs >> should display club details without map
- Location: /home/tobias/usr/nrfc/nrfc-fixtures/tests/playwright/clubs.spec.ts:39:7
...
Call log:
  ...
  - waiting for locator('h1')
    ...
    at /home/tobias/usr/nrfc/nrfc-fixtures/tests/playwright/clubs.spec.ts:43:38
```
...
- heading "No route found for \"GET http://localhost:8000/clubs/2\"" [level=1]
- img
- tablist:
...
- tabpanel:
  ...
  - paragraph: No routes found for "/clubs/2/".
- region "Symfony Web Debug Toolbar":
  - link "404":
    - /url: http://localhost:8000/_profiler/35f2a1?panel=request
  - link "98 ms":
    - /url: http://localhost:8000/_profiler/35f2a1?panel=time
  - link "4.0 MiB":
    - /url: http://localhost:8000/_profiler/35f2a1?panel=time
  - link "Logger 1":
    - /url: http://localhost:8000/_profiler/35f2a1?panel=logger
    - img "Logger"
    - text: "1"
  - link "Security n/a":
    - /url: http://localhost:8000/_profiler/35f2a1?panel=security
    - img "Security"
    - text: n/a
  - link "Twig 2 ms":
    - /url: http://localhost:8000/_profiler/35f2a1?panel=twig
    - img "Twig"
    - text: 2 ms
  - link "Symfony 7.2.5":
    - /url: http://localhost:8000/_profiler/35f2a1?panel=config
    - img "Symfony"
    - text: 7.2.5

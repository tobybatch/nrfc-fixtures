 ...
 */
final class Version20250724164105 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE club (id SERIAL NOT NULL, name VARCHAR(255) NOT NULL, address VARCHAR(255) DEFAULT NULL, latitude DOUBLE PRECISION DEFAULT NULL, longitude DOUBLE PRECISION DEFAULT NULL, notes TEXT DEFAULT NULL, aliases JSON DEFAULT NULL, PRIMARY KEY(id))
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE fixture (id SERIAL NOT NULL, club_id INT DEFAULT NULL, date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, home_away VARCHAR(255) NOT NULL, competition VARCHAR(255) NOT NULL, team VARCHAR(255) NOT NULL, name VARCHAR(255) DEFAULT NULL, notes TEXT DEFAULT NULL, opponent VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))
        SQL);
        $this->addSql(<<<'SQL'

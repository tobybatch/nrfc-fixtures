...
final class PageController extends AbstractController
{
    ...
    #[Route('/page/all', name: 'app_fixture_all')]
    ...
    #[Route('/page/team/{team}', name: 'app_fixture_team')]
    ...
    #[Route('/page/{fixture}', name: 'app_fixture_single')]
    public function fixture(Fixture $fixture): Response
    {
        return $this->render('page/team.html.twig', []);
    }
}
